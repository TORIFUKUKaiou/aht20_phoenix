defmodule Aht20.MeasurementsTest do
  use Aht20.DataCase

  alias Aht20.Measurements

  describe "values" do
    alias Aht20.Measurements.Value

    @valid_attrs %{humidity: 120.5, temperature: 120.5, time: 42}
    @update_attrs %{humidity: 456.7, temperature: 456.7, time: 43}
    @invalid_attrs %{humidity: nil, temperature: nil, time: nil}
